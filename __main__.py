...
print("***************************************************************")
print("DO NOT CLOSE THIS TERMINAL FOR IT WILL CLOSE THE GUI IF CLOSED.")
print("***************************************************************")
main = Tk()
main.title('Topic Analysis of Mt. Mayon Eruption Tweets')
main.geometry('980x500')
main.maxsize(980,500)
main.minsize(980,500)
...
mi7 = PhotoImage(file="img/collect.jpeg ")
collect_button.config(image=mi7,compound=LEFT)
tmi7 = mi7.subsample(14,14)
collect_button.config(image=tmi7)
...
dpp_entry_1.insert(END, 'outputs/orginaldata.csv')
...
mi6 = PhotoImage(file="img/clean1.png")
dpp_button_3.config(image=mi6,compound=LEFT)
tmi6 = mi6.subsample(5,5)
dpp_button_3.config(image=tmi6)
...
mi4 = PhotoImage(file="img/import1.png")
dpp_button_import.config(image=mi4,compound=LEFT)
tmi4 = mi4.subsample(18,18)
dpp_button_import.config(image=tmi4)
...
mi3 = PhotoImage(file="img/browse1.png")
dpp_button_flbrowse.config(image=mi3,compound=LEFT)
tmi3 = mi3.subsample(10,10)
dpp_button_flbrowse.config(image=tmi3)
...
dpp_scrollbar.grid(row=3,sticky=W,padx=470,ipady=100)
...
mi8 = PhotoImage(file="img/update2.png")
tpcmdl_button1.config(image=mi8,compound=LEFT)
tmi8 = mi8.subsample(16,16)
tpcmdl_button1.config(image=tmi8)
...
tpcmdl_entry_1.insert(END,'outputs/cleaneddata.cds')
...
mi5 = PhotoImage(file="img/browse1.png")
tpcmdl_flbrowse.config(image=mi5,compound=LEFT)
tmi5 = mi5.subsample(10,10)
tpcmdl_flbrowse.config(image=tmi5)
...
mi = PhotoImage(file="img/list.png")
lbling_button.config(image=mi,compound=LEFT)
tmi = mi.subsample(8,8)
lbling_button.config(image=tmi)

lbling_button2 = Button(page4, bg="#173F5F",fg="white",font = "Arial 12 bold",text ="Add New Label",command=lambda: addnewlabel())
mi1 = PhotoImage(file="img/add.png")
lbling_button2.config(image=mi1,compound=LEFT)
tmi1 = mi1.subsample(16,16)
lbling_button2.config(image=tmi1)

lbling_button3 = Button(page4, bg="#173F5F",fg="white",font = "Arial 12 bold",text ="Remove a Label",command=lambda: remlabel())
mi2 = PhotoImage(file="img/remove.png")
lbling_button3.config(image=mi2,compound=LEFT)
tmi2 = mi2.subsample(16,16)
lbling_button3.config(image=tmi2)
...
def genertp2(name):
    def viewpyldavis():
        new=2
        webbrowser.open('outputs/LDA_Visualization.html',new=new)
    def freqbar(model):
        if(model=='lda'):
            usmdls.ldafreqbar()
        else:
    ...
    def viewwrcld(model):
        if(model=='lda'):
            ...
            plt.savefig('outputs/LDAWordCloud')
            plt.show()
        else:
            ...
            plt.axis('off')
            plt.imshow(wordcloud)
            plt.savefig('outputs/NMFWordCloud')
            plt.show()
    def openresultwindow():
        ...
        if(algotbused==1):
            ...
            hitwrd = open('files/generatedoutputs/hitwordsLDA.txt','a')
            conts = fl3.readline()
            flag=0
            num = 0
            topicsg = []
            ...
            hitwrd = open('files/generatedoutputs/hitwordsNMF.txt','a')
            conts = fl.readline()
            flag=0
            num = 0
            topicsg = []
    ...
    def topicmdling(name):
        ...
        print(algotbused)
        if(algotbused==1):
            text = "LDA: Number of topics="+ldaparam_entry_1.get()+", Word Per Topic="+ldaparam_entry_6.get()+", Iterations="+ldaparam_entry_3.get()+", Training Passes="+ldaparam_entry_5.get()+", LDA Model="+ldaparam_opmenu_variable.get()+"\n"
            ...
            fl1 = open("files/generatedoutputs/ldaresult.res","w")
            fl1.write("".join(outres1))
            fl1.close()
            tpcmdl_entry_4.insert(END,'Success\n')
            tpcmdl_entry_4.see(tk.END)
        else:
            text = "NMF: Number of topics="+nmfparam_entry_1.get()+", Word Per Topic="+nmfparam_entry_3.get()+", Vectorizer Max Features="+nmfparam_entry_2.get()+", Iterations="+ldaparam_entry_4.get()+"\n"
            tpcmdl_entry_4.insert(END,text)
            ...
            fl2 = open("files/generatedoutputs/nmfresult.res","w")
...
def dataclct2(query,num,startd,endd):
    ...
    class ThreadedTask(threading.Thread):
        ...
        def run(self):
            ...
            csvname = 'outputs/'+collect_entry_5.get()+'.csv'
            ...
            entrywrd = 'outputs/'+collect_entry_5.get()+".csv"
...
def datacleaning2(main,name):
    ...
    def cleaningdata(name):
        ...
        with open('outputs/'+fname,"wb") as filehandle:
    ...
    class ThreadedTask(threading.Thread):
        ...
        def run(self):
            ...
            with open("outputs/cleaneddata.cds","rb") as filehandle:
            ...
            entrywrd = 'outputs/'+dpp_entry_2.get()+".cds"
...
def viewstopwrds(main,stats):
    def updatestpwrds(stpwrds_extension,stats):
        if(stats==3):
            with open("files/stopwords/additional_stop_words_tagalog.asw","w") as filehandle:
            ...
            with open("files/stopwords/additional_stop_words.asw","w") as filehandle:
                filehandle.write(stpwrds_extension)
            dpp_entry_4.config(state='normal')
            dpp_entry_4.insert(END,'Stopwords Updated\n')
            dpp_entry_4.see(tk.END)
            ...
            with open("files/stopwords/additional_stop_words_mallet.asw","w") as filehandle:
                filehandle.write(stpwrds_extension)
            dpp_entry_4.config(state='normal')
            dpp_entry_4.insert(END,'Stopwords Updated\n')
            dpp_entry_4.see(tk.END)
...
def addnewlabel():
    ...
    def addnwlbl(lblname,lblmdl,lblhtwrds):
        if(lblmdl==1):
            print(1)
            with open("files/labeling/ldalabel-"+lblname+".lbl","w") as filehandle:
                filehandle.write(lblhtwrds)
            with open("files/labeling/lbllistlda.lst","a") as filehandle:
                filehandle.write(","+lblname)
        elif(lblmdl==2):
            with open("files/labeling/malldalabel-"+lblname+".lbl","w") as filehandle:
                filehandle.write(lblhtwrds)
            with open("files/labeling/lbllistldamal.lst","a") as filehandle:
                filehandle.write(","+lblname)
        else:
            with open("files/labeling/nmflabel-"+lblname+".lbl","w") as filehandle:
                filehandle.write(lblhtwrds)
            with open("files/labeling/lbllistnmf.lst","a") as filehandle:
                filehandle.write(","+lblname)
...
def viewalllabels():
    ...
    def chnglbllda(*args):
        ...
        with open('files/labeling/'+flname,'r') as flhandle:
    ...
    ldalabels = []
    with open('files/labeling/lbllistlda.lst','r') as fileh:
    ...
    malldalabels = []
    with open('files/labeling/lbllistldamal.lst','r') as fileh:
    ...
    nmflabels = []
    with open('files/labeling/lbllistnmf.lst','r') as fileh:
    ...
    def updatewords(lblname):
        if(lblname == 'Mallet LDA'):
            lblname = window_opmenu3_var.get()
            flname = 'malldalabel'+'-'+lblname+'.lbl'
            with open('files/labeling/'+flname,'w') as flhandle:
...
def remlabel():
    ...
    def viewlbls(*args):
        ...
        if(lstname=='Gensim LDA'):
            with open('files/labeling/lbllistlda.lst','r') as file:
                lsta = file.read()
            window_texta.insert(END,lsta)
        elif(lstname=='Mallet LDA'):
            with open('files/labeling/lbllistldamal.lst','r') as file:
                lsta = file.read()
            window_texta.insert(END,lsta)
        else:
            with open('files/labeling/lbllistnmf.lst','r') as file:
                lsta = file.read()
            window_texta.insert(END,lsta)
    def updtlst():
        ...
        lstname = window_opmenu_var.get()
        if(lstname=='Gensim LDA'):
            with open('files/labeling/lbllistlda.lst','w') as file:
                file.write(vals)
            window_texta.delete('1.0',END)
        elif(lstname=='Mallet LDA'):
            with open('files/labeling/lbllistldamal.lst','w') as file:
                file.write(vals)
            window_texta.delete('1.0',END)
        else:
            with open('files/labeling/lbllistnmf.lst','w') as file:
                file.write(vals)
            window_texta.delete('1.0',END)
